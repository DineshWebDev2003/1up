...
const actions = [
  { icon: 'calendar-check-outline', title: 'View Attendance', href: '/(common)/unified-attendance' },
  { icon: 'camera-outline', title: 'Live Camera', href: '/(common)/live-monitoring' },
  { icon: 'car-outline', title: 'Track Cab', href: '/(common)/track-cab' },
  { icon: 'clipboard-check-outline', title: 'Kids Attendance', href: '/(common)/new-attendance' },
 // { icon: 'account-clock-outline', title: 'Staff Attendance', href: '/(common)/staff-attendance' },
  { icon: 'calendar-remove-outline', title: 'Leave Requests', href: '/(common)/request-leave' },
  { icon: 'post-outline', title: 'Post Activity', href: '/(common)/post-activity' },
  { icon: 'lightbulb', title: 'Student Activities', href: '/(common)/kids-feed' },
].map((action, index) => ({ 
  ...action, 
