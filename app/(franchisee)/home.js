              ...
              <View style={styles.quickActionsGrid}>
                ...
                >
                  <LinearGradient colors={['#667eea', '#764ba2']} style={styles.quickActionGradient}>
                    ...
                    <Text style={styles.quickActionTitle}>Assign New User</Text>
                    <Text style={styles.quickActionSubtitle}>Add team members</Text>
                  </LinearGradient>
                </TouchableOpacity>
                ...
                <TouchableOpacity 
                  style={styles.quickActionCard}
                  onPress={() => router.push('/(common)/invoice-generator')}
                  activeOpacity={0.8}
                >
                  <LinearGradient colors={['#f093fb', '#f5576c']} style={styles.quickActionGradient}>
                    ...
                    <Text style={styles.quickActionSubtitle}>Create invoices</Text>
                  </LinearGradient>
                </TouchableOpacity>
                ...
                {/* Live Monitoring */}
                            <TouchableOpacity 
                  style={styles.quickActionCard}
                  onPress={() => router.push('/(common)/live-monitoring')}
                  activeOpacity={0.8}
                >
                  <LinearGradient colors={['#4facfe', '#00f2fe']} style={styles.quickActionGradient}>
                    <MaterialIcons name="videocam" size={32} color="white" />
                    <Text style={styles.quickActionTitle}>Live Monitoring</Text>
                    <Text style={styles.quickActionSubtitle}>Real-time surveillance</Text>
                  </LinearGradient>
                            </TouchableOpacity>
                      </View>
                    </View>
...
const styles = StyleSheet.create({
  ...
  quickActionGradient: {
    padding: 16,
    height: 140, // Same height as card
    justifyContent: 'center',
    alignItems: 'center',
  },
  quickActionTitle: {
