...
const actions = [
  ...
  { icon: 'business', title: 'Create Branch', route: '/(common)/create-branch', category: 'management', description: 'Add new school branches' },
  ...
  { icon: 'check-circle', title: 'Kids Attendance', route: '/(common)/new-attendance', category: 'academic', description: 'Manual attendance marking with guardian selection' },
  { icon: 'badge', title: 'Staff Attendance', route: '/(common)/staff-attendance', category: 'management', description: 'View staff attendance reports' },
  { icon: 'assignment', title: 'Leave Requests', route: '/(common)/request-leave', category: 'management', description: 'Manage leave requests' },
  { icon: 'payment', title: 'Fees Management', route: '/(common)/fees-management', category: 'financial', description: 'Manage fee structure' },
  { icon: 'credit-card', title: 'UPI Settings', route: '/(common)/upi-settings', category: 'financial', description: 'Manage UPI for payments' },
  ...
  { icon: 'receipt', title: 'Generate Invoice', route: '/(common)/invoice-generator', category: 'financial', description: 'Create student invoices' }
];
