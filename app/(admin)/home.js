...
const AdminHomeScreen = () => {
  ...
  const loadData = async () => {
    ...
    try {
      ...
      setUser(currentUser);
      setBranchName(currentUser.branch_name || currentUser.branch || 'All Branches');
      ...
      setUser({ name: 'Error', role: 'Admin', branch: 'Could not load' });
    } finally {
      setLoading(false);
    }
  };
          ...
          <Animatable.View animation="fadeInDown" duration={600} delay={100}>
            <View style={styles.welcomeHeader}>
              <View style={styles.welcomeContent}>
                ...
                <Text style={styles.welcomeSubtitle}>{branchName || 'System Administrator'}</Text>
              </View>
              <TouchableOpacity 
              ...
              >
                ...
                <View style={styles.roleBadge}>
                  <Text style={styles.roleText}>AD</Text>
                </View>
              </TouchableOpacity>
            </View>
          </Animatable.View>
              ...
              <View style={styles.statsRow}>
                <View style={styles.statCard}>
                  ...
                  >
                    ...
                    <Text style={styles.statValue}>₹{stats.total_income?.toLocaleString('en-IN') || '0'}</Text>
                  </LinearGradient>
                </View>
              ...
              <View style={styles.statsRow}>
                <View style={styles.statCard}>
                  <LinearGradient
                    ...
                    style={styles.statCardGradient}
                  >
                    <MaterialIcons name="business" size={28} color="white" />
                    <Text style={styles.statLabel}>Total Branches</Text>
                    <Text style={styles.statValue}>{stats.total_branches || '0'}</Text>
                  </LinearGradient>
                </View>
                ...
                <View style={styles.statCard}>
                  ...
                  >
                    ...
                    <Text style={styles.statValue}>{stats.total_franchisee || '0'}</Text>
                  </LinearGradient>
                </View>
              </View>
            </View>
