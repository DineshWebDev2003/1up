...
// Define school location directly since mock-data is deprecated
...
const updateDriverLocation = async (driverId, latitude, longitude) => {
  ...
  return (
    <View style={styles.container}>
      <MapView ref={mapRef} style={styles.map} customMapStyle={mapStyle} initialRegion={{ ...schoolLocation, latitudeDelta: 0.4, longitudeDelta: 0.4 }}>
        <Marker coordinate={schoolLocation} zIndex={10}>
