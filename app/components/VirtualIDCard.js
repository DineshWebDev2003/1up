  ...
  return (
    ...
    >
      ...
      <View style={styles.card}>
        {/* Header with School Number */}
        <View style={[styles.header, styles.yellowHeader]}>  {/* Yellow Header */}
          <Image source={require('../../assets/logo.png')} style={styles.logo} />
          <View style={styles.headerTextContainer}>
            <Text style={styles.schoolName}>TN Happy Kids Playschool</Text>
            <Text style={styles.schoolNumber}>☎️ {schoolNumber}</Text>
          </View>
        ...
        <View style={styles.contentVertical}>
          <View style={styles.profileContainerLarge}>
            <Image
              source={
          ...
          <View style={styles.infoContainer}>
            ...
            <Text style={styles.studentInfo}>Father Name: {fatherName}</Text>
            <Text style={styles.studentInfo}>Father No: {fatherNumber}</Text>
            <Text style={styles.studentInfo}>Blood Group: {bloodGroup}</Text>
            <Text style={styles.studentInfo}>Category: {student.category || 'N/A'}</Text>
        ...
        <View style={styles.footer}>
          <View style={styles.footerRow}>
            ...
            <View style={styles.footerRight}>
              ...
              <Text style={styles.footerValue}>{bloodGroup}</Text>
            </View>
          </View>
          <View style={[styles.footerRow, { marginTop: 8 }]}>
            <View style={styles.footerLeft}>
              <Text style={styles.footerLabel}>Father Name:</Text>
              <Text style={styles.footerValue}>{fatherName}</Text>
            </View>
            <View style={styles.footerRight}>
      ...
      <View style={styles.card}>
        {/* Back Header */}
        <View style={[styles.backHeader, styles.yellowHeader]}>  {/* Yellow Back Header */}
...
const styles = StyleSheet.create({
  ...
  card: {
    ...
    shadowOpacity: 0.2,
    shadowRadius: 5,
    height: 360,          // increased height for portrait orientation
    width: 220,           // narrower width to achieve vertical card layout
    overflow: 'hidden',
    alignSelf: 'center',
  },
  header: {
