...
$apiUrl = 'http://192.168.1.5/lastchapter/api/auth/login.php';
...
echo "<ul>";
echo "<li><a href='http://192.168.1.5/lastchapter/api/auth/login.php' target='_blank'>Direct API Link</a></li>";
echo "<li><a href='http://192.168.1.5/lastchapter/' target='_blank'>Base URL</a></li>";
echo "</ul>";
