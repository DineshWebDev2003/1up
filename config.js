...
// • Updated to use production server: appv5.tnhappykids.in/lastchapter
const getServerURL = () => {
  // FORCE LOCAL MODE - Always use local API for development (COMMENTED OUT)
  // console.log('[Config] FORCED LOCAL MODE – using LOCAL_API_URL:', LOCAL_API_URL);
